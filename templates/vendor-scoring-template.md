...
> **Template Origin**: Official | **ArcKit Version**: [VERSION] | **Command**: `/arckit.evaluate`
...
|---------|------|--------|---------|-------------|---------------|
| [VERSION] | [DATE] | ArcKit AI | Initial creation from `/arckit.evaluate` command | PENDING | PENDING |
...
**Details**: [Specific reason for disqualification]
