...
- **Helpers** — `~/.gemini/extensions/arckit/scripts/bash/create-project.sh` (project resolution) · `~/.gemini/extensions/arckit/scripts/generate-document-id.mjs` (document ID allocation)
