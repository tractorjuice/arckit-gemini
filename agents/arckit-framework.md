...
- **Templates** — `~/.gemini/extensions/arckit/templates/framework-overview-template.md` · `~/.gemini/extensions/arckit/templates/framework-executive-guide-template.md` (overrides at `.arckit/templates-custom/...`)
